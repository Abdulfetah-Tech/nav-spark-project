...
Keep responses concise and professional. Generate a complete message based on the user's brief description.`;
    ...
    console.log('Form helper suggestion generated successfully');
